Shader "PeerPlay/SphericalMask"
{
    Properties
    {
        _Color ("Color", Color) = (1,1,1,1)
        _MainTex ("Albedo (RGB)", 2D) = "white" {}
        _ColourStrength ("Colour Strength", Range(1,4)) = 1
        _EmissionColor ("Emission Color", Color) = (1,1,1,1)
        _EmissionTex ("Emission (RGB)", 2D) = "white" {}
        _EmissionStrength ("Emission Strength", Range(0,4)) = 1
        _Glossiness ("Smoothness", Range(0,1)) = 0.5
        _Metallic ("Metallic", Range(0,1)) = 0.0
        // GLOBALmask_Position ("World Position", Vector) = (0,0,0,0)
        // GLOBALmask_Radius ("Sphere Radius", Range(0,100)) = 0.0
        // GLOBALmask_Softness ("Sphere Softness", Range(0,1)) = 0.0
    ...
    SubShader
    {
        ...
        half _ColourStrength, _EmissionStrength;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            // Grayscale
            half grayscale = (c.r + c.g + c.g) * 0.333; // grayscale is the sum of the RGB values (divided by 3 as 3 chanles)
            ...
            fixed4 lerpColour = lerp(fixed4(c_g,1), c * _ColourStrength, sum);
            fixed4 lerpEmission = lerp(fixed4(0,0,0,0), e, sum);
            
            o.Albedo = lerpColour.rgb;
